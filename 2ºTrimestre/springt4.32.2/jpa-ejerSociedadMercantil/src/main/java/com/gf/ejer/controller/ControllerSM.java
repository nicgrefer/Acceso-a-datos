...
public class ControllerSM {
	...
	@GetMapping("/socios")
	public List<Socio> buscarSocios(@RequestBody Socio s) {
		return (List<Socio>)socioServices.findAll(s);
	}
	
	@GetMapping("/socios{id}")
	public Optional<Socio> buscarSociosId(@RequestBody Long id) {
		return socioServices.findId(id);
	}
	
	@DeleteMapping("/socios/{id}")
	public Optional<Socio> borrarSociosExiste(@RequestBody Long id) {
		return socioServices.delete(id);
	}
	
	@PutMapping("/socios/{id}")
	public Optional<Socio> actualizarSocio(@RequestBody Long id) {
		return socioServices.update(id);
	}
	
	@GetMapping("/lote{id}")
	public Optional<Lote> buscarLoteId(@RequestBody Long id){
		return lotesServices.findId(id);
	}
	
	@GetMapping("/lotes")
	public List<Lote> buscarLote(@RequestBody Lote l){
		return (List<Lote>)lotesServices.findAll(l);
	}
	...
	public Optional<Participacion> borrarParti(@RequestBody Long id){
